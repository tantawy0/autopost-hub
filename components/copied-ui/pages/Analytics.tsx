...
export default function Analytics() {
  ...
  return <div className="space-y-6"><div className="flex items-end justify-between flex-wrap gap-3"><div><h1 className="font-display text-3xl font-bold tracking-tight">Analytics</h1><p className="text-sm text-muted-foreground">Cross-channel performance for the last {days} days.</p></div><Button onClick={() => setDays((value) => value === 14 ? 30 : 14)} variant="outline" size="sm" className="border-border"><Calendar className="mr-1.5 h-3.5 w-3.5" /> Last {days} days</Button></div>
